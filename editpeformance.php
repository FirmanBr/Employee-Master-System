...
?>
	...
	<body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
			...
			<class="box-title"><h4><center>Update Peformance Record</h4></center>
			</div>
			</div>
			...
			<form class="form-horizontal" method="post" action="updatepeformance.php" enctype="multipart/form-data">
			    <div class="tab-content">
  					<div class="box-body"> 	
						...
						<div class="form-group">
  							<label for="tiga" class="col-sm-2 control-label">Year</label>
  							<div class="col-sm-10">
  							<input  type="text" class="form-control" placeholder="In Number" name="year" id="year" value="<?php echo $row['Year']; ?>">
							</div>
						</div>
						<div class="form-group">
  							<label for="tiga" class="col-sm-2 control-label">Description</label>
  							<div class="col-sm-10">
  							<input  type="text" class="form-control" placeholder="In Number" name="information" id="information" value="<?php echo $row['Information']; ?>">
							</div>
						</div>
						<div class="form-group">
