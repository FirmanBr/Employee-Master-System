...
?>
	...
	<body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
			...
			<class="box-title"><h4><center>Update Financial Record</h4></center>
			</div>
			</div>
			...
			<form class="form-horizontal" method="post" action="updatefinancial.php" enctype="multipart/form-data">
			    <div class="tab-content">
  					<div class="box-body"> 	
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
							<input type="text" class="form-control" placeholder="In Number" name="Salary" id="Salary" value="<?php echo $row['Salary']; ?>">
							</div>
						</div>
						<div class="form-group" id="main_Allowance" name="extra">		
  							<label for="tiga" class="col-sm-2 control-label">Allowance</label>
  							<div class="col-sm-10">
  							<input type="text" class="form-control" placeholder="Allowance" name="Allowance" value="<?php echo $row['Allowance']; ?>">
							</div>
						</div>							
						<div class="form-group">
